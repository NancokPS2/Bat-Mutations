# Status: Broken
Due to hard coded limitations, a pair of mutations from this category do not work and don't do anything outside of changing basic parameters (like ulginess), the mod will still run without errors
